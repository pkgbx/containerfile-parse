...
def as_dict(parser: ContainerfileParser) -> Dict[str, Any]:
    """
    Return the dict represenration of a ContainerfileParser(DockerfileParser).
    """
    data = {
...
def digest_instruction(data: Dict[str, Any]) -> str:
    """
